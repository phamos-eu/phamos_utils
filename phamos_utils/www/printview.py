...
def get_context(context):
	...
	values = frappe.db.get_value(
		"Print Settings",
		"Print Settings",
		["custom_is_test_format", "custom_watermark"],
		as_dict=True
	)

	is_test_format = values.custom_is_test_format
	water_mark = values.custom_watermark
	# end customize the print formats
	...
	return {
		...
		"letterhead": letterhead,
		"no_letterhead": frappe.form_dict.no_letterhead,
		"is_test_format": is_test_format, # customize the print formats - validate if it is a test format
		"water_mark": water_mark # customize the print formats - show watermark
	}
